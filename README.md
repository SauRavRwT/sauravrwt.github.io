...
1. **Fork the repository**
   - Navigate to the original repository and click on the "Fork" button at the top right corner.

2. **Clone your forked repository**
   ```bash
   git clone https://github.com/SauRavRwT/sauravrwt.github.io.git && cd sauravrwt.github.io
   ```
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  ```bash
   git clone https://github.com/SauRavRwT/sauravrwt.github.io.git
  ```
...
Note here that if you click [my portfolio](https://sauravrwt.github.io), you can see animating the logo at the beginning. I have designed that logo in [`Figma`](https://www.figma.com/) and then animated it using css.
